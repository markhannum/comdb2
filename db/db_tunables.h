...
REGISTER_TUNABLE("temptable_recreate_size", "Sets temptable re-create size threshold.  (Default: 1048576).",
                 TUNABLE_INTEGER, &gbl_temptable_recreate_size, 0, NULL,
                 NULL, NULL, NULL);
REGISTER_TUNABLE("debug_temptables", "Enables extended temptable trace.  (Default: off)", TUNABLE_BOOLEAN,
                 &gbl_debug_temptables, 0, NULL, NULL, NULL, NULL);
