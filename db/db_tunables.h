...
REGISTER_TUNABLE("comdb2_oplog_copy_entries", "Copy the most recent oplog entries after truncating oplog.  (Default: 10)", TUNABLE_INTEGER, &gbl_comdb2_oplog_copy_entries, 0, NULL, NULL, NULL, NULL);
