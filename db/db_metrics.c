...
comdb2_metric gbl_metrics[] = {
    ...
    {"page_reads", "Total page reads", STATISTIC_INTEGER, STATISTIC_COLLECTION_TYPE_LATEST, &stats.page_reads, NULL},
    {"page_writes", "Total page writes", STATISTIC_INTEGER, STATISTIC_COLLECTION_TYPE_LATEST, &stats.page_writes, NULL},
    {"fsyncs", "Fsync count", STATISTIC_INTEGER, STATISTIC_COLLECTION_TYPE_LATEST, &stats.fsyncs, NULL},
    {"mempgets", "Mempget count", STATISTIC_INTEGER, STATISTIC_COLLECTION_TYPE_LATEST, &stats.mempgets, NULL},
    {"page_bytes_read", "Total page bytes read", STATISTIC_INTEGER, STATISTIC_COLLECTION_TYPE_LATEST,
     &stats.page_bytes_read, NULL},
    {"page_bytes_written", "Total page bytes written", STATISTIC_INTEGER, STATISTIC_COLLECTION_TYPE_LATEST,
