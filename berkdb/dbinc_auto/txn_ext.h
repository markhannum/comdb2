...
int __txn_comdb2_prepare __P((DB_TXN *, u_int64_t dtranid, char *coordinator_name, char *coordinator_stage, u_int32_t coordinator_generation));
...
int __txn_regop_dist_log __P((DB_ENV *, DB_TXN *, DB_LSN *, u_int64_t *,u_int32_t,  u_int32_t, u_int32_t, u_int64_t, u_int64_t, u_int64_t, u_int32_t, const DBT *, const DBT *, u_int32_t, u_int64_t, const DBT *, void *));
int __txn_prepare_log __P((DB_ENV *, DB_TXN *, DB_LSN *, u_int32_t,  u_int32_t, u_int32_t, u_int64_t, u_int64_t, const DBT *, const DBT *, u_int32_t, const DBT *));
...
int __txn_regop_dist_read __P((DB_ENV *, void *, __txn_regop_dist_args **));
...
int __txn_regop_dist_recover __P((DB_ENV *, DBT *, DB_LSN *, db_recops, void *));
int __txn_prepare_recover __P((DB_ENV *, DBT *, DB_LSN *, db_recops, void *));
